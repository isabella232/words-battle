...
public class LetterPlaceSprite extends Sprite {
    ...
    public LetterPlaceSprite(int pIndex, float pX, float pY, TextureRegion pLetterPlaceTextureRegion, boolean pAvailable) {
